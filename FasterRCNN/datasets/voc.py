...
from datasets.training_sample import TrainingSample
...
class Dataset:
    ...
    def _generate_training_sample(self, filepath, flip):
        ...
        anchor_map, anchor_valid_map = anchors.generate_anchor_maps(image_shape=scaled_image_data.shape,
                                                                    feature_map_shape=self._compute_feature_map_shape_fn(
                                                                        scaled_image_data.shape),
    ...
    def _get_classes(self):
        ...
        return self.class_index_to_name
